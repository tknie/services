...
func NewInitFileRealm(realmFile string, createAutogenerated bool) *PasswordFileStruct {
...
func InitPasswordFile(passwordFile string) {
	log.Log.Debugf("Init password file %s", passwordFile)
	if defaultRealm == nil {
		defaultRealm = NewInitFileRealm(passwordFile, true)
		defaultRealm.realmWatcher()
	}
	if defaultRealm != nil {
...
func (rfs *PasswordFileStruct) scan() (err error) {
	...
	services.ServerMessage("Found %d users in realm file", count)
	return
}
...
func (rfs *PasswordFileStruct) readFile(lineBreak string) (err error) {
	...
	services.ServerMessage("Read %d entries of file %s", count, rfs.realmFile)
	return
}
...
func CheckPasswordFileUser(u, password string) (string, error) {
	...
	return defaultRealm.CheckPasswordFileUser(u, password)
}
